                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <div>
                            	用戶名<select name='userName' id='names' style='width:20%'></select>状态<select style='width:20%' name='state' id='state'>
                            	...
                            	<br />
                            	<input type="button" value='查询' onclick='selectWithdraw();' /><input type='submit' value='导出Excel' />
                            </div>
                            </form>

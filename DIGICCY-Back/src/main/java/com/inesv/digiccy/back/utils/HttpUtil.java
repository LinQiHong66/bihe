...
public class HttpUtil {
 ...
 public static String uploadFile(String uploadUrl, byte[] bbyte) {
        ...
        try {
           ...
           //httpURLConnection.setRequestProperty("Authorization", "AIzaSyDTnqJSb32GPHDx5tLltvwReldXr4PvLA4");
	...
	public static void main(String[] args) {
		/*String res = HttpUtil.sendPost("https://www.baidu.com", "");
		...
		String res = HttpUtil.createLinkString(params, true);
		System.out.println(res);

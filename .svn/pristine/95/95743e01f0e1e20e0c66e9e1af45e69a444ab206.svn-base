            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">修改API接口<</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>修改API接口<</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <%--<button class="btn btn-primary" id="btn_delete"><i class="icon-remove icon-white"></i>&nbsp;删除</button>--%>
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="hidden" name="id" id="id" class="form-control" style="border-radius: 5px" value="${api.data.id}">
                                    <input type="text" name="name" id="name" class="form-control" style="border-radius: 5px" value="${api.data.name}">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">API接口名称:</label>&nbsp;&nbsp;
                                    <input type="text" name="apiName" id="apiName" class="form-control" style="border-radius: 5px" value="${api.data.attr1}">
                                </div>
                                <div class="form-group" style="margin-top: 5px;" >
                                    <label class="form-label">API状态:</label>&nbsp;&nbsp;
                                    <select class="input-large m-wrap" tabindex="1" id="state" name="state">
                                    	<c:if test="${api.data.state==1}">
                                    		<option value="1" selected="selected">启用</option>
                                    		<option value="0">禁止</option>
                                    	</c:if>
                                    	<c:if test="${api.data.state==0}">
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">API简介:</label>&nbsp;&nbsp;
                                    <div class="controls">
                                    	<input style="display: none;" id="api_remark"
												name=""api_remark"" value='${api.data.remark}' />
                                        <script id="editor" type="text/plain" style="height: 400px;"></script> 
                                    </div>
                                    <input type="hidden" id="reamrk"  value="" name="remark"/>
...
<script src="/app/js/ajax/api_edit.js"></script>
...
<script type="text/javascript">
	var api_remark = $("#api_remark").val();
	var ue = UE.getEditor('editor');
	ue.ready(function() {
		ue.setContent(api_remark);
	});
</script>
<script>
	//实例化编辑器

...
class HttpUtils {
	 ...
	 * @throws Exception
	 */
	static HttpResponse doGet(String host, String path, String method, Map<String, String> headers,
	 ...
	 * @throws Exception
	 */
	static HttpResponse doPost(String host, String path, String method, Map<String, String> headers,

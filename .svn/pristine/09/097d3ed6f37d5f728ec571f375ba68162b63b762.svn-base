            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">API接口</a> <span class="divider">&nbsp;</span>
                        </li>
                        <li><a href="#">API接口列表</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>API接口列表</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                        		<a href="/api/gotoAdd.do"><button class="btn btn-success" id="btn_add"><i class="icon-plus icon-white"></i>&nbsp;新增</button></a>
                            	<table id="api_table">
                            </table>
                        </div>
                    </div>
...
<script src="/app/js/bootstrap-table/api-tab.js"></script>

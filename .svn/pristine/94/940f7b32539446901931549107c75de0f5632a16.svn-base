...
public class QiniuUploadUtil {
	...
	private static String accessKey = "zIKBtOC3lPDhhoC1HkhREki2WExOZXLtyGl5B2f_";
	private static String secretKey = "UnkuhF2-tUwe_WGOAqV8WfW53aGBAQwT5AUxCU3v";
	private static String bucket = "btc666";
	private static String startStaff = "http://owgfpneb2.bkt.clouddn.com/";

...
public class FicRechargePersistence {
    ...
    public Boolean ficRechargeTransac(Integer userNo,Integer coinNo,String to_ddress,BigDecimal bigPrice,Integer state,String txid,BigDecimal nowEnble, BigDecimal nowTotalprice) throws SQLException{
    	//添加虚拟币记录
    	 ...
    	 Object pasram[] = {userNo,coinNo,to_ddress,bigPrice,0,bigPrice,state,new Date(),txid};
    	 ...
    	 int res1 =  queryRunner.update(sql,pasram);
    	 int res2 = queryRunner.update(sql2,pasram2);
    	 if((res1+res2)==2) {
    		 return true;
    	 }else {
    		 return false;

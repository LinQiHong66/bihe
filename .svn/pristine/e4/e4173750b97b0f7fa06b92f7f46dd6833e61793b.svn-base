...
public class InesvUserDto {
	...
	public String toString() {
		return "InesvUserDto{" + "id=" + id + ", username='" + username + '\'' + ", user_no=" + user_no + ", password='"
				+ password + '\'' + ", region='" + region + '\'' + ", real_name='" + real_name + '\'' + ", mail='"
				+ mail + '\'' + ", phone='" + phone + '\'' + ", phone_state='" + phone_state + '\''
				+ ", certificate_type=" + certificate_type + ", certificate_num='" + certificate_num + '\''
				+ ", deal_pwd='" + deal_pwd + '\'' + ", deal_pwdstate=" + deal_pwdstate + ", validate_pwd='"
				+ validate_pwd + '\'' + ", validate_pwdstate='" + validate_pwdstate + '\'' + ", alipay='" + alipay
				+ '\'' + ", alipay_state='" + alipay_state + '\'' + ", state=" + state + ", invite_num='" + invite_num
				+ '\'' + ", date=" + date + ", photo='" + photo + '\'' + ", photo_state=" + photo_state + '}';
	}
}

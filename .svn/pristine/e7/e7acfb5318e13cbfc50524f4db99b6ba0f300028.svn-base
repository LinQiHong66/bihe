            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">API接口申请</a> <span class="divider">&nbsp;</span>
                        </li>
                        <li><a href="#">API接口申请列表</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>API接口申请列表</h4>
                            <span class="tools">
...
<script src="/app/js/bootstrap-table/apiDetail-tab.js"></script>
